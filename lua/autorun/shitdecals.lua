...
if CLIENT then
    local func = function()
        for i = 1, 11 do
            ...
            mat:SetFloat("$decalscale", 0.08)
            //mat:SetFloat("$decalscalevariation", 0.08)
            //mat:Recompute()
        end

        local mat = Material("effects/droplets/drop12")
    
        mat:SetFloat("$decalscale", 0.05)
        mat:Recompute()

        //local mat = Material("effects/droplets/drop13")
        ...
        */
        ...
        //local mat2 = CreateMaterial("effects/droplets/drop14", "DecalModulate", {
        ...
        //local mat2 = Material("!effects/droplets/drop14")
        //mat2:SetTexture("$basetexture", mat:GetTexture("$basetexture"))
        //mat2:Recompute()

        //hook.Add("HUDPaint", "nasdasdasd", function()
    ...
    hook.Add("InitPostEntity", "sadasdasdasdghyh", function()
        func()
    end)

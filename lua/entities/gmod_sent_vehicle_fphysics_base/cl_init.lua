...
function ENT:SetPoseParameters( curtime )
	...
	self.BadSurfaceLerp = LerpFT(0.2,self.BadSurfaceLerp or 0, (self:GetDrivingOnBadSurface() and (math.random(-1,1)/5)*(self:GetVelocity():Length()/2500) or 0))
	self:SetPoseParameter("vehicle_steer", self.sm_vSteer/1.7 + self.BadSurfaceLerp)

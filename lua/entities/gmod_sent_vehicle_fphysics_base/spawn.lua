...
function ENT:InitializeVehicle()
	...
	//self.DriverSeat:SetModel( "models/props_junk/PopCan01a.mdl" )
	...
	//self.DriverSeat:SetPos( View.ViewPos + self.DriverSeat:GetUp() * (-27 + self.SeatOffset.z) + self.DriverSeat:GetRight() * (5 + self.SeatOffset.y) + self.DriverSeat:GetForward() * (-6 + self.SeatOffset.x) )
	...
	self.DriverSeat:SetAngles( View.ViewAng )
	//self.DriverSeat:SetAngles( View.ViewAng + Angle(0,90,0) )
	...
	if self.PassengerSeats then
		for i = 1, table.Count( self.PassengerSeats ) do
			...
			//self.pSeat[i]:SetModel( "models/props_junk/PopCan01a.mdl" )
			self.pSeat[i]:SetKeyValue( "vehiclescript","scripts/vehicles/prisoner_pod.txt" )
			self.pSeat[i]:SetKeyValue( "limitview", 0)
			//self.pSeat[i]:SetAngles( self:LocalToWorldAngles( self.PassengerSeats[i].ang + Angle(0, 90, -15) ) )
			//self.pSeat[i]:SetPos( self:LocalToWorld( self.PassengerSeats[i].pos ) + self.pSeat[i]:GetAngles():Up() * 10 + self.pSeat[i]:GetAngles():Right() * -5 )

...
SWEP.Author = "Georg Luger"
SWEP.Instructions = [[Немецкий самозарядный пистолет времен Первой и Второй мировой войны.
Классический дизайн с откидным затвором, использует магазин на 8 патронов калибра 9x19mm Parabellum.
Пистолет был стандартным оружием офицерского состава Вермахта.]]
SWEP.Category = "Weapons - Pistols"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/comradebear/ww2/w_p08.mdl"
SWEP.WorldModelFake = "models/weapons/comradebear/ww2/c_p08.mdl"

SWEP.FakePos = Vector(-18, 2.0, 3.5)
...
SWEP.FakeReloadSounds = {
	...
	[0.5] = "comradebear/wpn/ger/p08/handling/luger_magout.wav",
	--[0.45] = "weapons/tfa_ins2/usp_tactical/magout.wav",
	--[0.37] = "weapons/m4a1/m4a1_magrelease.wav",
	[0.6] = "comradebear/wpn/ger/p08/handling/luger_magin.wav",
...
SWEP.LocalMuzzlePos = Vector(17, 0.2, 2.2)
...
SWEP.Primary.Sound = {"comradebear/wpn/ger/p08/luger_fp.wav", 75, 90, 100}

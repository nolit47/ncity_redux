-- "addons\\mcity\\lua\\weapons\\weapon_hg_throwingknife.lua"
-- Retrieved by https://github.com/lewisclark/glua-steal
﻿if SERVER then AddCSLuaFile() end
SWEP.PrintName = "Throwing Knife"
SWEP.Category = "ZCity Other"
SWEP.Instructions = "A sharp handcrafted knife suitable for throwing."
SWEP.Spawnable = true
...
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/fc5/throwingknife.mdl"

SWEP.ScrappersSlot = "Other"

if CLIENT then
	SWEP.WepSelectIcon = Material("vgui/fc5_tk")
	SWEP.IconOverride = "vgui/fc5_tk"
...
function SWEP:PrimaryAttack()
	...
	ent.WorldModel = "models/weapons/fc5/throwingknife.mdl"
	local ply = self:GetOwner()
	ent:SetPos(select(1, hg.eye(ply,60,hg.GetCurrentCharacter(ply))) - ply:GetAimVector() * 2)
	-- Set angles so the blade points forward (pitch 90 degrees to make blade horizontal)
	...
	if IsValid(phys) then
		...
		-- Remove angular velocity to prevent spinning

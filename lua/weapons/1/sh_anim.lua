...
hook.Add("Bones", "homigrad-lean-bone", function(ply)		
	...
	ply.lean = Lerp(hg.lerpFrameTime2( ( left or right ) and 0.045 * ply:GetNetVar("leanSpeedMul",1) or 0.075, dtime), ply.lean or 0, (left and right and 0) or (left and 1) or (right and -1) or 0)
	if SERVER then

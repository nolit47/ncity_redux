...
SWEP.WorldModelFake = "models/weapons/cod2019/c_shot_r90.mdl" -- ОЧЕНЬ странная проблема с модельками глеба, работать начинают только если ты включишь камеру на игрока, возможно проблема в рендероверайде...
//SWEP.FakeScale = 1.5

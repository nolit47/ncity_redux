...
SWEP.Instructions = [[Немецкий пистолет-пулемёт времен Второй мировой войны.
Разработан компанией Erma Werke для Вермахта.
Использует магазин на 30 патронов калибра 9x19mm Parabellum.
Темп стрельбы 500 выстрелов в минуту.
Стандартное оружие пехоты и десантных подразделений.]]
SWEP.Category = "Weapons - Machine-Pistols"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/comradebear/ww2/w_mp40.mdl"
SWEP.WorldModelFake = "models/weapons/comradebear/ww2/c_mp40.mdl"
//SWEP.FakeScale = 1.2
//SWEP.ZoomPos = Vector(0, -0.0027, 4.6866)
SWEP.FakePos = Vector(-19, 2.9, 10.5)
...
SWEP.FakeReloadSounds = {
	...
	[0.4] = "comradebear/wpn/ger/mp40/handling/mp40_magout.wav",
	--[0.34] = "weapons/ak74/ak74_magout_rattle.wav",
	[0.65] = "weapons/universal/uni_crawl_l_02.wav",
	[0.8] = "comradebear/wpn/ger/mp40/handling/mp40_magin.wav",
...
SWEP.LocalMuzzleAng = Angle(2.0, 0.5, 0)

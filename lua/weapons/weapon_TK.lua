...
SWEP.PrintName = "ТК (Тульский Коровина)"
SWEP.Author = "Тульский оружейный завод"
SWEP.Instructions = [[Советский самозарядный пистолет времен Великой Отечественной войны.
Разработан С.А. Коровиным на Тульском оружейном заводе.
Использует магазин на 15 патронов калибра 9x19mm Parabellum.
Был разработан как простое и надежное оружие для командного состава.
Известен также как пистолет Коровина образца 1926 года.]]
SWEP.Category = "Weapons - Pistols"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/w_ww2_korovin.mdl"
SWEP.WorldModelFake = "models/weapons/v_ww2_korovin.mdl"

SWEP.FakePos = Vector(-17, 2.0, 3.50)
...
SWEP.LocalMuzzlePos = Vector(1, 0.15, 2.15)
SWEP.LocalMuzzleAng = Angle(0, 0, 0)
SWEP.WeaponEyeAngles = Angle(0.2, 0.2, 0)
...
SWEP.Primary.Sound = {"weapons/tfa_ww2_korovin_pistol/korovin-1.wav", 75, 90, 100}
...
SWEP.ZoomPos = Vector(1, -0.1, 2.85)

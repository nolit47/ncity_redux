...
local Boxes = {
    ...
    ["NATO_SMALL_Military"] = { 
        EntTable = {
            ...
            "weapon_hg_smokenade", "weapon_fn45", "weapon_deagle", "ent_att_supressor7", "ent_att_supressor2",
    ...
    ["RUS_BIG_Military"] = { 
        EntTable = {
            "weapon_asval", "weapon_akm", "weapon_hg_rgd_tpik", "weapon_makarov", "weapon_hg_smokenade",
    ...
    ["RUS_SMALL_Military"] = { 
        EntTable = {
            "weapon_ak74", "weapon_ak74u", "weapon_hg_rgd_tpik", "weapon_makarov", "weapon_hg_smokenade",
    ...
    ["CITIZEN_Wardrobe"] = { 
        EntTable = {
            ...
            "weapon_hg_grenade_pipebomb", "weapon_bat", "weapon_zoraki", "ent_ammo_9mmpakflashdefense", "weapon_p22", 
    ...
    ["CITIZEN_RandomBox"] = { 
        EntTable = {
            ...
            "weapon_hg_grenade_pipebomb", "weapon_bat", "weapon_zoraki", "ent_ammo_9mmpakflashdefense", 

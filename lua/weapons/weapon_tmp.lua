...
--SWEP.WorldModelFake = "models/weapons/fml/smg/c_mp9.mdl"
//SWEP.FakeScale = 1.2
//SWEP.ZoomPos = Vector(0, -0.0027, 4.6866)
SWEP.FakePos = Vector(-17.5, 3.22, 9.55)
SWEP.FakeAng = Angle(1.5, 0.8, -0.5)
...
SWEP.FakeReloadEvents = {
	...
	[0.3] = function( self ) 
		if CLIENT and self:Clip1() < 1 then
			hg.CreateMag( self, Vector(20,25,-55) )
...
SWEP.holsteredPos = Vector(-2, 8, -8)

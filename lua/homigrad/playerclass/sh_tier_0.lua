-- "addons\\homigrad\\lua\\homigrad\\playerclass\\sh_tier_0.lua"
...
hook.Add("PostDrawAppearance", "PlayerClass", function(ent,ply) if IsValid(ply) and ply:IsPlayer() then ply:PlayerClassEvent("PlayerDraw",ply) end end)

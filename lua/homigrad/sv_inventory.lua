...
hook.Add("PlayerDropWeapon", "homigrad-inventory", function(ply)
    ...
    timer.Simple(0.1,function()
        ...
        local localpos,localang = LocalToWorld(wep.WorldPos or vector_origin,wep.WorldAng or angle_zero,handpos,handang)
        ...
        local cons = constraint.Weld(wep, ent, 0, physbone, 300, true, false)
...
hook.Add("PlayerLoadout", "nigga", function(ply)

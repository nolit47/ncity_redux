...
-- Disable 'otrub' (unconscious) state globally by clearing it every organism tick.
-- This prevents any module from setting players to unconscious.
hook.Add("Org Think", "homigrad-disable-otrub", function(owner, org, mulTime)
	if istable(org) then
		org.otrub = false
		org.needotrub = false
	end

...
local function addBloodPart(pos, vel, mat, w, h, artery, kishki, owner)
	...
	if #bloodparticles1 > 300 then table.remove(bloodparticles1, 1) end
	
	bloodparticles1[#bloodparticles1 + 1] = {pos, pos2, vel, mat or mat_huy, w or 2, h or 2, artery = artery, kishki = kishki, owner = owner, start_velocity = IsValid(owner) and owner:GetVelocity() or vector_origin}
end
...
local function addBloodPart2(pos, vel, mat, w, h, time, water, owner)
	...
	if #bloodparticles2 > 300 then table.remove(bloodparticles2, 1) end

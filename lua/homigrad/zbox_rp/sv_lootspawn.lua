...
-- hg.WeightedRandomSelect
--; у бро размер таба 3 пробела (и этот бро даже табом не пользуется)... мне слишком лень это чинить в адекватный стиль
...
local Boxes = {
	["NATO_BIG_Military"] = { 
		EntTable = {
			...
			{1, "weapon_sr25"},
			{1, "weapon_xm1014"},
			{1, "ent_armor_headphones1"},
			{5, "ent_armor_vest1"},
			{1, "ent_armor_vest4"},
			{5, "ent_armor_helmet1"},
			{5, "ent_armor_helmet5"},
			{1, "ent_armor_nightvision1"},
			{1, "ent_att_optic6"},
			{1, "ent_att_holo4"},
			{1, "ent_att_holo15"},
			{1, "ent_att_optic7"},
			...
			{1, "ent_att_holo14"},
			{1, "ent_att_optic9"},
			{10, "ent_ammo_5.56x45mm"},
			{10, "ent_ammo_5.56x45mmm856"},
			{10, "ent_ammo_5.56x45mmap"},
			{10, "ent_ammo_7.62x51mm"},
			{10, "ent_ammo_9x39mm"},
			{10, "ent_ammo_12/70gauge"},
			{10, "ent_ammo_12/70slug"},
			{20, "hg_sling"},
			{20, "weapon_walkie_talkie"},
		}, 
	...
	["NATO_SMALL_Military"] = { 
		EntTable = {
			{1, "weapon_mp7"},
			 {1, "weapon_mp5"},
			 {1, "weapon_p90"},
			 {2, "weapon_hg_grenade_tpik"},
			 {5, "weapon_hg_flashbang_tpik"},
			{5, "weapon_hg_smokenade"},
			 {5, "weapon_fn45"},
			 {2, "weapon_deagle"},
			 {4, "ent_att_supressor7"},
			 {4, "ent_att_supressor2"},
			{1, "ent_att_optic6"},
			 {1, "ent_att_holo4","ent_att_holo15"},
			 {1, "ent_att_optic7"},
			 {1, "ent_att_optic8"},
			{1, "ent_att_holo1"},
			 {1, "ent_att_holo14","ent_att_optic9"},
			 {10, "ent_ammo_5.56x45mm"},
			 {10, "ent_ammo_5.56x45mmm856"},
			{10, "ent_ammo_5.56x45mmap","ent_ammo_7.62x51mm"},
			 {10, "ent_ammo_9x39mm"},
			 {10, "ent_ammo_12/70gauge"},
			{10, "ent_ammo_12/70slug"},
			 {1, "ent_att_grip2"},
	...
	["RUS_BIG_Military"] = { 
		EntTable = {
			{1, "weapon_asval"},
			 ...
			 {5, "weapon_makarov"},
			 {6, "weapon_hg_smokenade"},
			{10, "weapon_melee"},
			 {10, "weapon_sogknife"},
			 {10, "ent_ammo_9x39mm"},
			 {10, "ent_ammo_7.62x39mm"},
			{1, "ent_att_supressor1"},
			 {1, "ent_att_supressor8"},
			 {1, "ent_att_holo6"},
			 {1, "ent_att_holo5"},
			 {1, "ent_att_holo7"},
			{1, "ent_att_optic3"},
	...
	["RUS_SMALL_Military"] = { 
		EntTable = {
			{1, "weapon_ak74"},
			 ...
			 {3, "weapon_hg_rgd_tpik"},
			 {3, "weapon_makarov"},
			 {1, "weapon_hg_smokenade"},
			{5, "weapon_melee"},
			 {5, "weapon_sogknife"},
			 {10, "ent_ammo_5.45x39mm"},
			 {10, "ent_ammo_7.62x39mm"},
			 {10, "ent_ammo_9x18mm"},
			{1, "ent_att_supressor1"},
			 {1, "ent_att_supressor8"},
	...
	["POLICE_SmallLocker"] = { 
		EntTable = {
			{1, "weapon_glock17"},
			 ...
			 {10, "weapon_hg_tonfa"},
			 {10, "weapon_handcuffs"},
			 {10, "weapon_handcuffs_key"},
			{1, "weapon_taser"},
			 {1, "ent_att_holo16"},
			 {1, "ent_att_laser3"},
			 {1, "hg_flashlight"},
			 {1, "ent_ammo_9x19mmparabellum"},
			 {1, "hg_sling"},
			 {1, "weapon_walkie_talkie"},
		}, 
	...
	["CITIZEN_Wardrobe"] = { 
		EntTable = {
			{1, "weapon_remington870"},
			 ...
			 {1, "ent_armor_vest3"},
			{40, "weapon_bigconsumable"},
			 {40, "weapon_smallconsumable"},
			 {20, "weapon_ducttape"},
			 {10, "hg_flashlight"},
			 {1, "ent_ammo_9x19mmparabellum"},
			{1, "weapon_hg_grenade_pipebomb"},
			 {10, "weapon_bat"},
			 {2, "weapon_zoraki"},
			 {2, "ent_ammo_9mmpakflashdefense"},
			 {1, "weapon_p22"},
			{1, "ent_ammo_.22longrifle"},
			 {2, "weapon_revolver2"},
		}, 
	...
	["CITIZEN_RandomBox"] = { 
		EntTable = {
			...
			{1, "weapon_hg_grenade_pipebomb"},
			 {10, "weapon_bat"},
			 {1, "weapon_zoraki"},
			 {1, "ent_ammo_9mmpakflashdefense"},
			{1, "ent_ammo_.357magnum"},
			 {1, "ent_ammo_.45acp"},
		}, 
		Models = {"models/props_c17/FurnitureDrawer002a.mdl"},
			 {1, "models/props_c17/FurnitureDrawer003a.mdl"}
	},
	["CITIZEN_Fridge"] = { 
		EntTable = {
			{1, "weapon_smallconsumable"},
			 {1, "weapon_bigconsumable"},
		}, 
	...
	["MEDICAL_Big"] = { 
		EntTable = {
			{70, "weapon_bandage_sh"},
			 {10, "weapon_betablock"},
			 {50, "weapon_painkillers"},
			 {40, "weapon_tourniquet"},
			 {1, "weapon_naloxone"},
			{10, "weapon_medkit_sh"},
			 {1, "weapon_adrenaline"},
			 {10, "weapon_needle"},
...
--\\
	PLUGIN.LootContainers = PLUGIN.LootContainers or {}

	function PLUGIN.ReSpawnLootCrates()
		for ent, _ in pairs(PLUGIN.LootContainers) do
			if(IsValid(ent))then
				ent:Remove()
			end
		end
		
		PLUGIN.LootContainers = {}
		...
		for k, spot in pairs(spots[game.GetMap()]) do
			...
			ent.LootTable = tbl
			local model = table.Random(Boxes[spot[1]].Models)
			ent.Model = model
	...
	PLUGIN.Hooks["InitPostEntity"] = function()
		...
		timer.Simple( 5, function()
			PLUGIN.ReSpawnLootCrates()
		end)
	end

	PLUGIN.Hooks["PostCleanupMap"] = function()
		if not spots[game.GetMap()] then return end

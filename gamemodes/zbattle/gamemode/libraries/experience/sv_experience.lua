...
function plyMeta:GetExp()
    ...
    return zb.Experience.PlayerInstances[self:SteamID64()].experience or 0
...
function plyMeta:GiveExp( ammout )
    ...
    //if !zb.Experience or !zb.Experience.PlayerInstances or !zb.Experience.PlayerInstances[self:SteamID64()] then return end

    //zb.Experience.PlayerInstances[self:SteamID64()].experience =  math.max( zb.Experience.PlayerInstances[self:SteamID64()].experience or 0 + ammout, 0 )
    ...
    //local points = math.min(ammout/2,10)// * (1 + ply:HasPurchase("zpremium"))

    //if self:EA_HasAccess() then
    //    self:PS_AddDPoints(math.Round(points/2))
    //end
    //self:PS_AddPoints(math.Round(points))
...
--[[
    ...
    zb.Experience.PlayerInstances[self:SteamID64()].skill = math.max( zb.Experience.PlayerInstances[self:SteamID64()].skill + ammout, 0 )
...
function plyMeta:GiveDeaths( ammout )
    ...
    //zb.Experience.PlayerInstances[self:SteamID64()].deaths = math.max( zb.Experience.PlayerInstances[self:SteamID64()].deaths + ammout, 0 )
...
function plyMeta:GiveKills( ammout )
    ...
    //zb.Experience.PlayerInstances[self:SteamID64()].kills = math.max( zb.Experience.PlayerInstances[self:SteamID64()].kills + ammout, 0 )
...
function plyMeta:GiveSuicides( ammout )
    ...
    //zb.Experience.PlayerInstances[self:SteamID64()].suicides =  math.max( zb.Experience.PlayerInstances[self:SteamID64()].suicides + ammout, 0 )

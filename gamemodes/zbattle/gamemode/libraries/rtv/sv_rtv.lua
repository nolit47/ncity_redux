...
--;; ===================================
util.AddNetworkString("ZB_RTV_start")
util.AddNetworkString("ZB_RTV_vote")
util.AddNetworkString("ZB_RTV_voteCLreg")
util.AddNetworkString("ZB_RTV_end")
zb = zb or {}
local cooldown = {}
local votes = {}
...
net.Receive("ZB_RTV_vote", function(len, ply)

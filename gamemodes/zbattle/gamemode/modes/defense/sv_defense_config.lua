...
DEFENSE_COMMANDER_ITEMS = {
    ...
    ["Explosives"] = {
        ...
        {name = "Pipe Bomb", entity = "weapon_hg_grenade_pipebomb", price = 20, desc = "Improvised explosive device", icon = "vgui/entities/weapon_hg_grenade_pipebomb"}
    },
    ["Tactical Support"] = {

...
function MODE:Intermission()
    ...
    PrintMessage(HUD_PRINTTALK, "Round "..(self.Rounds + 1 - zb.RoundsLeft).." out of "..(self.Rounds + 1)..".")
...
concommand.Add("tdm_setrounds", function(ply, cmd, args)
    ...
    MODE.Rounds = math.max(tonumber(args[1]) or oldRounds, 1) - 1
    zb.RoundsLeft = math.max(MODE.Rounds - played, 0)
    PrintMessage(HUD_PRINTTALK, "TDM rounds set to "..(MODE.Rounds+1)..". Rounds left: "..zb.RoundsLeft)
end)

...
function MODE:HUDPaint()
	...
	for n,points in pairs(PointsProgress) do
		local pos = ( ScrW()/2 - sizeW/2 ) + sizeW * (i)
		draw.RoundedBox(3,pos,ScrH()-sizeH,sizeW*math.abs(points/100),sizeH,points < 0 and hohColor or wagColor)
		draw.RoundedBox(0,pos,ScrH()-sizeH,sizeW,sizeH,bgColor)
		draw.DrawText(n.." "..(points == 0 and "" or points < 0 and "UA" or "RU"),"ZB_HomicideSmall", pos + sizeW/2,ScrH()-sizeH,color_white,TEXT_ALIGN_CENTER)
		i = i + 1
	end

...
hook.Add("HUDPaint", "DrawTraitorPanel", function()
    ...
    local title = is_main and "TRAITOR COMMAND" or "TRAITOR ASSISTANT"
    ...
    if is_main then
        ...
        if has_assistants then
            ...
            for _, traitor_info in ipairs(MODE.TraitorsLocal) do
                ...
                if ply.MainTraitor and ply.CurAppearance and traitor_info[2] == ply.CurAppearance.Name then
                    continue
                end
                ...
                for _, v in ipairs(player.GetAll()) do
                    if v.isTraitor and v.CurAppearance and v.CurAppearance.Name == name then
                        player_found = v
                        break
                    end
                end
